                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <Card.Title  className="facts">  <VisibilitySensor onChange={this.onVisibilityChange} offset={{
                                    ...
                                    <CountUp className={style.countup} start={0} end={this.state.didViewCountUp ? 150 : 0}
                                        duration={5} />
                            ...
                            <Card.Body>
                                <Card.Title  className="facts">
                                    <VisibilitySensor onChange={this.onVisibilityChange} offset={{
                                        ...
                                        <CountUp className={style.countup} start={0} end={this.state.didViewCountUp ? 100 : 0}
                                            duration={5} />
                                    </VisibilitySensor> Billion+
